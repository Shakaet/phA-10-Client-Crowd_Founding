...
<section className="impact-metrics py-8 bg-gray-50 dark:bg-gray-800">
  <Zoom>
    <h2 className="text-2xl sm:text-3xl font-bold text-center mb-6 text-gray-900 dark:text-gray-100">
      Impact Metrics
    </h2>
  ...
  <div className="container mx-auto grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-6 px-4">
    {[
      { label: "Campaigns Completed", value: "1,024" },
      { label: "Funds Raised", value: "$1.2M" },
      { label: "Active Donors", value: "15,786" },
      { label: "Volunteers Engaged", value: "2,345" },
    ].map((metric, index) => (
      <Slide direction="up" key={index}>
        <div className="metric bg-white dark:bg-gray-900 text-gray-900 dark:text-gray-100 rounded shadow p-6 text-center">
...
<section className="testimonials py-8 bg-gradient-to-r from-blue-100 to-blue-200 dark:from-gray-800 dark:to-gray-900">
  <Zoom>
    <h2 className="text-2xl sm:text-3xl font-bold text-center mb-6 text-gray-900 dark:text-gray-100">
      Testimonials
    </h2>
  ...
  <div className="container mx-auto grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 px-4">
    {[1, 2, 3].map((_, index) => (
      <Slide direction="up" key={index}>
        <div className="testimonial bg-white dark:bg-gray-900 text-gray-900 dark:text-gray-100 rounded shadow p-6 text-center">
          <p className="text-sm italic mb-4">"This platform has changed my life! Highly recommended."</p>
          <h3 className="text-lg font-bold">User {index + 1}</h3>
        </div>
      </Slide>
    ))}
  </div>
...
{/* FAQ Section */}
<section className="faq py-8 bg-gray-50 dark:bg-gray-800">
  <Slide direction="up">
    <h2 className="text-2xl sm:text-3xl font-bold text-center mb-6 text-gray-900 dark:text-gray-100">
    ...
    {[
      {
        ...
        answer: "To start a campaign, click on 'Start a Campaign' and fill out the necessary details.",
      },
      {
        question: "How can I donate?",
        answer: "You can browse campaigns and click 'Donate' to support a cause.",
      },
      {
        question: "Is my information secure?",
        answer: "Yes, we prioritize your privacy and ensure that your data is secure.",
      },
    ].map((faq, index) => (
      <Fade key={index}>
        <div className="faq-item bg-white dark:bg-gray-900 text-gray-900 dark:text-gray-100 rounded shadow p-4 mb-4">
